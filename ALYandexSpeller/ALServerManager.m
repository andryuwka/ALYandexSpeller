...
- (id)init {
  ...
  if (self) {
    NSURL *url =
    [NSURL URLWithString:@"https://speller.yandex.net/services/spellservice.json/"];
...
- (void)checkText:(NSString *)text
  ...
  NSDictionary *params = [NSDictionary dictionaryWithObjectsAndKeys:text, @"text", lang, @"lang", options, @"options", ie, @"ie", nil];
                         ...
                         parameters:params
                            success:^(AFHTTPRequestOperation *operation, id responseObject) {
                              ...
                              for(NSDictionary *dict in responseObject) {
                                ...
                                ALSpellResult *temp = [[ALSpellResult alloc] initWithStrings:[dict objectForKey:@"s"]
